...
import yhao.micro.service.surety.business.apilist.model.enums.guarantee.LoanPaymentTypeEnum;
...
/**
 * @Description:
 * @Created by ql on 2019/1/2 18:06
 * @Version: v1.0
 */
public class LoanBuyerSaveForm extends IdUnForm {
	...
	@ApiModelProperty(value = "商贷银行ID(非交易类的贷款银行ID)，这里关联的是资方管理里面的具体支行ID")
	private String loanMbId;

	@ApiModelProperty(value = "商贷金额(非交易类的贷款金额)")
	...
	private LoanPaymentTypeEnum loanPaymentType;

	@ApiModelProperty(value = "新贷款备注")
	...
	public LoanPaymentTypeEnum getLoanPaymentType() {
		return loanPaymentType;
	}

	public void setLoanPaymentType(LoanPaymentTypeEnum loanPaymentType) {
